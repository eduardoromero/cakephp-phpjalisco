...
<div class="ui basic segment actions">
    ...
    <?php echo $this->Form->postLink("<i class='ui list black icon'></i> " . __('Delete'), array('action' => 'delete', $this->Form->value('Rating.id')), array('class' => 'ui icon red button', 'escape' => false, 'confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Rating.id')))); ?>
