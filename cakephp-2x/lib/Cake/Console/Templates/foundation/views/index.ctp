...
<div class="row">
    <div class="large-12 medium-12 small-12 columns">
        ...
        <div class="<?php echo $pluralVar; ?> index">
            ...
            <table class="large-12 medium-12 small-12 hover">
                <thead>
                <tr>
            ...
            <?php echo "<?php echo \$this->element('FoundationPaginate'); ?>" ?>
        ...
        <div class="actions">
            ...
            <div class="small button-group">
                <?php echo "<?php echo \$this->Html->link(__('New " . $singularHumanName . "'), array('action' => 'add'), array('class' => 'button')); ?>\n"; ?>
                <?php
                $done = array();
